...
- STO는 “새로운 금융시장” 성격이 강해서 향후 3~5년간 제도·시장 변화가 많을 가능성이 큼.(2023년 기준)
    ...
    실제로 3년이 경과하면서 2026.1.15 전자증권법·자본시장법 [개정안](https://www.fsc.go.kr/no010101/86064)이 국회 본회의를 통과하는 등 예상대로 큰 변화가 있었음. 이 개정안이 한국형 STO의 핵심 기준으로 격상됨
...
- 한국형 STO 시장의 큰 특징(금융당국 발표 검토 결과):
    ...
    3. 토큰증권을 거래할 별도의 장외거래소(전용 거래 인프라)를 신설하고, 입법·시행령 등을 거쳐 기준에 맞춰 운영한다는 계획
        ...
        2026년 2월 13일 금융위원회가 장외거래중개업 예비인가 사업자로 KDX(키움증권·교보생명·카카오페이증권 등)와 NXT(넥스트레이드·신한투자증권·뮤직카우 등) 2곳을 선정 완료. 6개월 내 본인가 신청 필요. 루센트블록은 탈락
...
- 2023년 2월 발표한 정비방안의 핵심 메시지:
    ...
    - 디지털 자산 전반은 (자본시장법 + 향후 디지털자산기본법 등)으로 시장 전체 규율체계를 만들어간다는 구도
        ...
        가상자산이용자보호법이 2024년 7월 19일 시행됨 (1단계 입법).
        
        디지털자산기본법이 2025년 6월 10일 민병덕 의원에 의해 발의되어 국회 논의 중 (2단계 입법).
        
        - 인가·등록·신고제 3단계 진입 체계, 스테이블코인 특별 규제, 대통령 직속 디지털자산위원회 설치 등 포함
        </aside>
...
- “디지털 자산” 영역은 별도 체계(입법 예정)로 규율
    ...
    가상자산이용자보호법은 시행 완료, 디지털자산기본법은 발의·논의 중으로 "입법 예정" 단계를 넘어섬
...
- 제도 방향
    ...
    - 장외거래 중개업자는 신규 라이선스/기준으로 선정·허가.
        - 기존 코인 거래소 업자의 참여는 불허 입장도 언급.
            ...
            실제로 코인거래소는 참여하지 않았으며, 금융사·핀테크 기업 중심으로 선정됨
...
- 투자계약증권 제도화의 목적(감독당국 설명 요지)
    - 현재 시범/샌드박스 형태로 운영되던 조각투자·공동투자를 제도권으로 끌어와
        ...
        2025년 6월 16일부터 비금전신탁 수익증권 조각투자 발행플랫폼이 정식 제도화됨. "수익증권 투자중개업" 스몰라이센스(자기자본 10억원)가 신설됨. 조각투자 유통플랫폼·비상장주식 유통플랫폼은 2025년 9월 30일 제도화
...
- 지금은 법규상 형태가 명확히 고정되지 않아 샌드박스/시범 형태로 운영되던 것들이 많았음.
    ...
    2025.6.16 비금전신탁 수익증권 조각투자 발행플랫폼이 정식 제도화되며 샌드박스 단계를 졸업. 투자계약증권도 총 7건 72.7억원 발행 완료
...
- 감독·심사 쪽 메시지
    ...
    - 실무 담당자 메시지 요지: 투자자 안정성을 최우선 과제로 둔다.
        ...
        2024년 금감원이 투자계약증권 투자자 보호 모범규준을 마련: 청약 전·후 기초자산 직접 확인 절차, 발행인 선배정·장기보유 의무, 투자적합성 테스트, 투자자 장부열람권·투자자총회 소집권 부여 등
...
- 코인(Coin)
    ...
    - 한국 제도 설계에서는 코인 시장과 STO 시장을 유통 인프라까지 분리하려는 기조가 강함.(코인거래소와 STO 거래가 겹치지 않도록)
        ...
        2024.7.19 가상자산이용자보호법 시행으로 코인 시장도 제도권 편입이 시작되었으나, 코인/STO 분리 기조는 유지됨. 장외거래중개업 예비인가에도 코인거래소는 참여·선정되지 않음
...
- 한국형 STO를 제도화하려면 법 개정이 필요하다는 설명.
    ...
    2026년 1월 15일 전자증권법·자본시장법 개정안이 국회 본회의를 통과함. 공포 후 1년(2027년 1월 잠정) 시행 예정
    
    - 전자증권법 개정 핵심: 분산원장을 증권 계좌부로 이용 가능, 발행인 계좌관리기관 등록요건 신설(자기자본 10억원 이상 등)
    - 자본시장법 개정 핵심: 투자계약증권의 증권사(투자매매·중개업자)를 통한 유통 허용
    </aside>
...
- 다만 당시 기준으로는 장외거래중개업자 허가 요건(시설/규모/인력 등)은 구체 발표 전.
    
    <aside>
    💡

    → 3절 장외거래중개업 예비인가 참조. 코인 거래소는 실제로 참여·선정되지 않음
...
- 정책 발표 → 관련법 정비 → 감독·심사 체계 준비 → 실제 승인 사례 등장
    ...
    - “현재는 실물발행 또는 법적으로 인정되는 방식으로만 발행 가능”이라는 전제
        ...
        법 통과로 분산원장 기반 발행이 법적으로 허용됨 (시행은 2027.1)
    ...
    | 2024.7.19   | 가상자산이용자보호법 시행 |
    |-------------| --- |
    | 2024년       | 금감원, 투자계약증권 투자자 보호 모범규준 마련 |
    | ~2025초      | 투자계약증권 총 7건, 72.7억원 발행 완료 (미술품, 한우 등) |
    | 2025.6.10   | 디지털자산기본법안 발의 (민병덕 의원) |
    | 2025.6.16   | 비금전신탁 수익증권 조각투자 발행플랫폼 정식 제도화, 스몰라이센스 신설 |
    | 2025.7.1    | 투자계약증권·비금전신탁 수익증권 이익을 배당소득으로 과세 시행 |
    | 2025.9.30   | 조각투자 유통플랫폼·비상장주식 유통플랫폼 제도화 |
    | 2025.11     | 전자증권법·자본시장법 개정안 정무위 통과 |
    | 2026.1.15   | 전자증권법·자본시장법 개정안 국회 본회의 통과 |
    | 2026.2      | 금융위, 토큰증권 협의체 구성 예정 (기술·인프라/발행제도/유통제도 3개 분과) |
    | 2026.2.13   | 장외거래중개업 예비인가 2곳(KDX, NXT) 선정 |
    | 2027.1 (잠정) | 개정 법률 시행 예정 |
    </aside>
...
- 결론: 개정안 통과 전에도 감독당국·거래소 등이 개정안 통과 후를 대비한 실질 준비를 진행 중
    ...
    2026.1.15 개정안 통과 완료. 2026.2월 토큰증권 협의체(기술·인프라/발행제도/유통제도 3개 분과) 구성으로 시행 준비 돌입
...
4. 지속적인 전문 기술회사 제휴
    ...
    장외거래중개업 예비인가 2곳 선정(→ 3절 참조), 주요 증권사 플랫폼 구축 추진(→ 19절 참조) 등으로 위 요건들이 실제 사업 단계로 진입 중
...
- 현장 의견 공통점(요약)
    ...
    2025~2026년 기준, 대부분의 주요 증권사가 STO 전담 조직 신설 및 플랫폼 인프라 구축을 완료하거나 진행 중인 상태로 전환됨
...
- 2023년 상반기 기준, KB증권·NH투자증권·신한투자증권 등 대형사가 중심이 되어 협의체/얼라이언스/비전그룹 형태로 파트너를 모으는 전략이 두드러짐.
    ...
    - 미래에셋증권: SK텔레콤·하나금융그룹과 'NFI(넥스트 파이낸스 이니셔티브)' 컨소시엄 구성, STO 플랫폼 1단계 완료, 전담 조직 확대
    - 한국투자증권: 업계 최초 토큰증권 발행 인프라 구축 완료
    - KB증권: STO 플랫폼 1단계 개발 완료
    - IBK투자증권: 업계 최초 토큰증권·스테이블코인 상표권 출원
    - 키움증권: KDX 장외거래소 컨소시엄 참여 (예비인가 선정)
    - 신한투자증권: NXT 장외거래소 컨소시엄 참여 (예비인가 선정)
    - 그 외 메리츠·삼성·대신 등도 플랫폼 구축·업무협약 진행
    </aside>
...
- 후속 승인 대기 상품(2024년 1월 기준 언급)
    ...
    이후 실제로 총 7건, 72.7억원의 투자계약증권이 발행됨. 투게더아트는 제4회차까지 신고서 제출
...
- 한계/시사점
    - 당시에는 발행만 가능(2차 유통 인프라 부재) → 배당이나 기초자산 매각 외에는 투자자 수익 실현 경로가 제한
        ...
        여전히 2차 유통은 제한적이나, 장외거래중개업 예비인가 2곳이 선정되어 향후 유통 인프라가 구축될 전망 (→ 3절 참조)
...
2. STO 자금조달 효율성 + 투자자 보호 강화를 위한 제도적 정비 필요
    ...
    - 개인 투자한도/범위 제한은 초기 금융위 가이드가 있으나, 시장 형성에 영향이 커 재논의 중(한도가 너무 낮으면 시장 형성 제약).
        ...
        스몰라이센스(자기자본 10억원) 신설 등으로 구체화 진행 (→ 6절 참조)
    ...
    - KRX(한국거래소) 디지털자산 시장으로 토큰증권을 이관할 때 생기는 기술·제도 이슈도 계속 검토 중이며, 최종안 도출엔 시간이 필요 → 지속적 연구 필요.
        ...
        KRX 신종증권 장내시장은 시스템·규정이 완성되었으나, 상장 상품이 없어 1년 넘게 개장 미뤄지는 중. 상장 요건(자기자본 20억원, 공모금액 30억원 등)이 까다로워 발행사들이 장외시장을 선호하는 상황
...
시장 규모 전망: BCG 추산 2024년 국내 STO 시장 34조원, 2030년 367조원(GDP 약 14.5%) 전망. 글로벌 RWA(실물자산) 토큰화 시장은 2030년 약 16.1조 달러(약 2경 2,000조원) 전망. 위 과제들이 해결될수록 이 시장이 현실화될 가능성이 높아짐
...
전자증권법 개정(2026.1.15 통과)으로 분산원장 기반 전자등록 발행이 법적으로 허용됨. 실물 발행 불필요라는 기존 답변이 제도적으로도 확립됨
...
13. 과세 관련 기재는 어느 수준으로 해야 하나? (사례/유권해석 불확실)
    ...
    2025년 7월 1일부터 투자계약증권·비금전신탁 수익증권 형태 조각투자 이익이 배당소득으로 과세하는 것이 확정됨
    
    - 참고: 금융투자소득세 폐지 (원래 2025.1.1 시행 예정이었으나 폐지됨), 가상자산 과세는 2027.1.1로 2년 유예
    </aside>
